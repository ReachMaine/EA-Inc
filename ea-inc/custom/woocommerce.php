...
add_filter( 'woocommerce_product_tabs', 'woo_remove_product_tabs', 98 );
  ...
  */
  ...
  function eai_checkout_message( ) {
   echo '<div class="eai-checkout-message"><h3>If you have trouble placing your order, please send an email to <a target="_blank"  href="mailto:support@ellsworthamerican.com">support@ellsworthamerican.com</a> or call <a href="tel:2076672576">(207) 667-2576</a>.</h3></div>';
  }
